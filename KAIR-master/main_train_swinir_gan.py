...
'''
# --------------------------------------------
# training code for SwinIR GAN-based model
# --------------------------------------------
    ...
    for epoch in range(1000000):  # keep running
        ...
        for i, train_data in enumerate(train_loader):
            ...
            if current_step % opt['train']['checkpoint_test'] == 0 and opt['rank'] == 0:
                ...
                # testing log
                logger.info('<epoch:{:3d}, iter:{:8,d}, Average PSNR : {:<.2f}dB | SSIM: {:<.4f} | IT-SSIM: {:<.4f}'.format(epoch, current_step, avg_psnr, avg_ssim, avg_it_ssim))
