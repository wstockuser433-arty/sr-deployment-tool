...
hr_path = "/home/hassan/Documents/Hassan/SR-Enhancement-Work/Datasets/maxar-dataset-pak/pakistan-flood-images-36cm/1040010076369100-visual.tif"
...
if hr_path.lower().endswith('.png'):
    ...
    with rasterio.open(hr_path) as src:
        ...
        if src.count >= 3:
            ...
            # Stretch contrast per channel (percentile-based - very effective)
            def stretch(band):
...
save_path = "hr_rgb_visualized.png"
